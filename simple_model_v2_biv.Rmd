...
# Order the data by match_id in ascending order
setorder(dataco_all_events_1516_prob, match_id)
...
dataco_all_events_1516_bivariate_fit[, `:=` (
...
cols_to_round <- c("total_goals", "supremacy", "phi","cov_lambda" ,"expH" ,"expA" )
...
#write.csv(dataco_all_events_1516_bivariate_fit, "dataco_all_events_1516_bivariate_fit.csv", row.names = FALSE)
